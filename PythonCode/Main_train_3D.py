...
parser.add_argument('--test_patch_size', type=int, default=64, help='the crop size of the image used for validation')
parser.add_argument('--test_z_size', type=int, default=8, help='the crop z size of the image used for validation')
    ...
    for i, train_data in enumerate(train_loader):
        ...
        if current_step % opt['train']['checkpoint_test'] == 0:
            ...
            for test_data in test_loader:
                ...
                util.mkdir(img_dir)
                # test_patch_range = [0,params.test_patch_size,0,params.test_patch_size]
                model.feed_data(test_data,test_patch_size=-1,need_R=True,
                                test_patch_range=[0,params.test_patch_size,0,params.test_patch_size],test_z_range=[0,params.test_z_size])
