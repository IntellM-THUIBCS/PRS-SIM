...
def parse(opt_path, is_train=True, smpl_name='', net_type='', save_suffix=''):
    ...
    opt['task'] = smpl_name + '_' + net_type + save_suffix
    ...
    for phase, dataset in opt['datasets'].items():
        ...
        # dataset['dataroot'] = os.path.join(opt['dataroot'], smpl_name)
