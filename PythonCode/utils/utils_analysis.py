...
# numIteration = 1 # original value is 3


# # Select image for estimation

# from utils.utils_analysis import noiseLevelEstimation
# import math
# nle = noiseLevelEstimation(img)
# sigma_n = math.sqrt(nle) if nle>=0 else -1


# pathI="test_imgs/clean_2.tif"
